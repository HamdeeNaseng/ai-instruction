#!/usr/bin/env python3
"""
Main demo runner for Claude API demonstrations
Run all demos or specific ones based on user choice
"""
...
def check_api_key():
    ...
    try:
        ...
        # dotenv not required, just check environment
        pass
    ...
    if not api_key:
        ...
        print("2. Or create .env file with: ANTHROPIC_API_KEY=your-key")

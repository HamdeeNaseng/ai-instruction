...
- Easy .env access from root directory
"""
...
def print_banner():
    ...
    print(f"📁 Java Transform Dir: {java_transform_dir}")
    print("="*80)
...
def check_prerequisites() -> Dict[str, bool]:
    ...
    sample_project = java_transform_dir / "code-samples" / "imedX"
...
class AIGuidedMigration:
    ...
    def _step1_project_selection(self):
        ...
        # Show available projects - adjusted for root directory
        code_samples_dir = java_transform_dir / "code-samples"
    ...
    def _step3_legacy_analysis(self):
        ...
        try:
            # Ensure we can import from java-transformation directory
            import sys
    ...
    def _step4_transformation_planning(self):
        ...
        try:
            ...
            # Ensure java-transformation is in sys.path before import
            import sys
            java_transform_path = Path(__file__).parent / "java-transformation"
            if str(java_transform_path) not in sys.path:
                sys.path.insert(0, str(java_transform_path))
...
"""
    ...
    def _show_final_summary(self):
        ...
        transform_outputs = Path("java-transformation/transformation-outputs")
        if transform_outputs.exists():
            output_files.append(f"📁 {transform_outputs}")
        
        # Check for testing reports
        rd_analytics = Path("java-transformation/rd_runner_analytics")
